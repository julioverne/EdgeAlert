...
@interface EdgeAlertSettingsController : PSListController
{
	UILabel* _label;
	UILabel* underLabel;
}
...
@implementation EdgeAlertSettingsController
- (id)specifiers {
	if (!_specifiers) {
		...
		[spec setProperty:@{@"defaults": @"com.julioverne.edgealert",
				@"key": @"Color",
				@"fallback": @"#0090ff",
				@"PostNotification": @"com.julioverne.edgealert/SettingsChanged",
		...
		spec = [PSSpecifier preferenceSpecifierNamed:@"Width"
											  ...
											  cell:PSSliderCell
											  edit:Nil];
		[spec setProperty:@"Width" forKey:@"key"];
		[spec setProperty:@(4.0f) forKey:@"default"];
		[spec setProperty:@(0.0f) forKey:@"min"];
		[spec setProperty:@(10.0f) forKey:@"max"];
		...
		spec = [PSSpecifier preferenceSpecifierNamed:@"Height"
											  ...
											  cell:PSSliderCell
											  edit:Nil];
		[spec setProperty:@"proportionSize" forKey:@"key"];
		[spec setProperty:@(1.4f) forKey:@"default"];
		[spec setProperty:@(1.0f) forKey:@"min"];
		[spec setProperty:@(4.0f) forKey:@"max"];
		[spec setProperty:@NO forKey:@"isContinuous"];
		[spec setProperty:@YES forKey:@"showValue"];
        [specifiers addObject:spec];
		...
		[spec setProperty:@(2.0f) forKey:@"default"];
		[spec setProperty:@(0.1f) forKey:@"min"];
		[spec setProperty:@(6.0f) forKey:@"max"];
		[spec setProperty:@NO forKey:@"isContinuous"];
		[spec setProperty:@YES forKey:@"showValue"];
        [specifiers addObject:spec];
		
		spec = [PSSpecifier preferenceSpecifierNamed:@"Duration Seconds"
		                                      target:self
											  set:Nil
											  get:Nil
                                              detail:Nil
											  cell:PSGroupCell
											  edit:Nil];
		[spec setProperty:@"Duration Seconds" forKey:@"label"];
		[specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"Duration Seconds"
                                              target:self
											  set:@selector(setPreferenceValue:specifier:)
											  ...
											  cell:PSSliderCell
											  edit:Nil];
		[spec setProperty:@"DurationTime" forKey:@"key"];
		[spec setProperty:@(10.0f) forKey:@"default"];
		[spec setProperty:@(0.1f) forKey:@"min"];
		[spec setProperty:@(60.0f) forKey:@"max"];
		[spec setProperty:@NO forKey:@"isContinuous"];
		[spec setProperty:@YES forKey:@"showValue"];
        [specifiers addObject:spec];
        ...
        [specifiers addObject:spec];
		spec = [PSSpecifier emptyGroupSpecifier];
        [spec setProperty:@"EdgeAlert © 2017" forKey:@"footerText"];
        [specifiers addObject:spec];
...
- (void)love
{
	...
	[twitter setInitialText:@"#EdgeAlert by @ijulioverne is cool!"];
	if (twitter != nil) {
...
- (void)reset
{
	...
	notify_post("com.julioverne.edgealert/SettingsChanged");
...
- (void)HeaderCell
{
	@autoreleasepool {
		...
		[underLabel setText:@"S8 Edge Alert"];
